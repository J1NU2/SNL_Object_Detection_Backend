...
def get_result():
    ...
    # (2)프론트엔드 폴더로 절대경로 수정!!!!!
    filenames = os.listdir('D:/VSCode/project/frontend/static/img/')
    print(filenames)
    file = filenames[-1]
    # (3)프론트엔드 폴더로 절대경로 수정!!!!!
    abs_path = f'D:/VSCode/project/frontend/static/img/{file}'
...
def post_result(user):
    ...
    file = filenames[-1]
    file_path = f'D:/VSCode/project/frontend/static/img/{file}'
